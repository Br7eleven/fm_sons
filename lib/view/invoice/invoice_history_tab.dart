...
Generated by FM Sons Billing App
  ...
  Widget _buildChip(String label, _InvoiceFilter filter, Color selectedColor) {
      ...
      child: ListView(
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                _buildChip('All', _InvoiceFilter.all, Colors.indigo),
                const SizedBox(width: 10),
                _buildChip('Pending', _InvoiceFilter.pending, Colors.orange),
                const SizedBox(width: 10),
                _buildChip('Backed Up', _InvoiceFilter.backedUp, Colors.green),
                const SizedBox(width: 10),
                _buildChip('Paid', _InvoiceFilter.paid, Colors.teal),
              ],
            ),
          ),
