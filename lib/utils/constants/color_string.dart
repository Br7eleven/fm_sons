...
class FMSons {
  ...
  static const Color textPrimary = Color(0xFF0B1220); // Headings
  static const Color textSecondary = Color(0xFFD4AF37); // Body text
  static const Color textColor = Color(0xFFFFFFFF);
  static const Color textColor2 = Color(0xFFF59E0B);
}
